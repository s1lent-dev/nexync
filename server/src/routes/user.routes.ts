...
import { acceptConnectionRequest, getAllConnections, getConnectionRequests, getMe, getMyConnections, getSuggestions, removeFollowing, removeFollowers, searchUsers, sendConnectionRequest, unsendConnectionRequest, updateBio, updateUsername, uploadAvatar } from "../controllers/user.controller.js";
...
userRouter.route('/remove-follower/:userId').delete(verifyToken, removeFollowers);
